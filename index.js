...
var message = `${famous_person} once said that:,"${quote}"`;
// USe console.log to print the message
console.log(message);
//___________________________________________________________________________________________________________________________
// 2 => compose a personal message 
var tabish = "Hello Eric, would you like to learn some Python today?";
console.log(tabish);
//___________________________________________________________________________________________________________________________
// 3 =>compose message in upper,lower or title case
var upper_case = "Snow White and the Seven Dwarves.";
...
var num5 = 108;
var num6 = 100;
var addition = num1 + num1 + num1 + num1;
...
var subtraction = num5 - num6;
console.log("The subtraction result is:", subtraction);
//___________________________________________________________________________________________________________________________
// 6=> Write a person's Quote
var fav_person = "Albert Einstein";
var quote_2 = "A person who never made a mistake never tried anything new.";
var message_2 = `${fav_person} once said that: "${quote_2}"`;
...
var names = ['Hamza', 'Yasir', 'Faizan', 'Fazeel'];
console.log(names[0]);
console.log(names[1]);
console.log(names[2]);
console.log(names[3]);
...
var names = ['Hamza', 'Yasir', 'Faizan', 'Fazeel'];
var message = "HELLO kesy ho bahi jan.";
...
var names = ["Ali Abdullah", "Zartash Sharf", "Abdul Rashid", "Tabish almas", "Zahid Irfan", "M Javed"];
...
var guest = "Obviosly I would like to invite living persons on dinner.";
var guest_names = ['Rana', 'Hassan', 'Danish', 'Tabish', 'Muazzam', 'Arslan', 'Fazeel', 'Adeel Muratza', 'Naveed'];
var invite = ":Hello my dear, I would like to invite you with your family on dinner at my home.It will glad moment if you come.";
...
let country = ["Pakistan", "india", "Afganistan", "Iran", "Sudia Arabia", "Iraq",];
